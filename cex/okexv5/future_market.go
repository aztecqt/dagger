 ...
 * @LastEditTime: 2023-10-03 10:56:50
...
func (m *FutureMarket) Init(ex *Exchange, instID string, depthFromTicker, tickerFromRest bool) {
	m.CommonMarket.Init(ex, instID, depthFromTicker, tickerFromRest)
	m.markpriceOK = false
