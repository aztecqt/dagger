 ...
 * @LastEditors: aztec
 * @LastEditTime: 2023-03-08 20:57:29
...
type Detail struct {
	...
	DataLineBrief DataLineBrief          `json:"dl_brief"`
}
...
func (d *Deal) From(deal common.Deal) {
	...
	d.TimeStampMicro = deal.O.GetUpdateTime().UnixMicro()
	d.TimeStempMs = deal.O.GetUpdateTime().UnixMilli()
	d.Price = deal.Price
